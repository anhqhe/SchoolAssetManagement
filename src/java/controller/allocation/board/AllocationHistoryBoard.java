 ...
 * @author Leo
 */
@WebServlet(name="AllocationHistoryBoard", urlPatterns={"/board/allocation-history"})
public class AllocationHistoryBoard extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(AllocationHistoryBoard.class.getName());
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Error loading allocation history (board)", e);
