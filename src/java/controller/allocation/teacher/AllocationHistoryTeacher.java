 ...
 * @author Leo
 */
@WebServlet(name="AllocationHistoryTeacher", urlPatterns={"/teacher/allocation-history"})
public class AllocationHistoryTeacher extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(AllocationHistoryTeacher.class.getName());
        ...
        try {
            ...
            if (idParam != null && !idParam.isBlank()) {
                ...
                if (allocationId != null) {
                    AllocationHistoryDTO detail = allocationDAO.getAllocationDetail(
                            allocationId, currentUser.getUserId());
                    if (detail != null) {
            ...
            LOGGER.log(Level.SEVERE, "Error loading allocation history (teacher)", e);
            session.setAttribute("type", "error");
            session.setAttribute("message", "Không tải được danh sách cấp phát.");
