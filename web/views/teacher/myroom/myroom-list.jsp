...
<head>
    <meta charset="UTF-8">
    <title>Phòng Của Tôi | School Asset Management</title>
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">
                        <i class="fas fa-door-open text-primary"></i> Danh sách phòng phụ trách
                    </h1>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <i class="fas fa-list"></i> Các phòng đang phụ trách
                                ...
                                %>
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">
                                            ...
                                            <p>Chưa có phòng nào được phân công</p>
                                        </td>
                                    </tr>
                                <%
                                    } else {
                                        ...
                                        <td class="text-center" style="white-space:nowrap;">
                                            <a href="<%= request.getContextPath() %>/teacher/myrooms/detail?id=<%= room.getRoomId() %>"
                                               class="btn btn-sm btn-info" title="Xem chi tiết phòng">
                                                <i class="fas fa-eye"></i> Xem tài sản
                                            </a>
                                        </td>
                                    </tr>
                                <%
