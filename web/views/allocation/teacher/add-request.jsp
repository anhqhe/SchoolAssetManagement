...
<head>
    ...
    <style>
        .request-container { max-width: 800px; margin: 30px auto; }
            ...
            <div id="content">
                ...
                <div class="container request-container">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/teacher/request" method="post">

                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <label class="form-label">Phòng nhận tài sản:</label>
                                        <select name="requestedRoomId" class="form-select">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="purpose" class="form-control" placeholder="Ví dụ: Giảng dạy môn Tin học">
                                    </div>
                                </div>
