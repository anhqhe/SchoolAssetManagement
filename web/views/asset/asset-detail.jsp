<%-- 
    ...
    Created on : Feb 7, 2026, 7:44:45 PM
    Author     : An
--%>
                                                    ...
                                                    <div class="col-md-8 detail-value">
                                                        <c:choose>
                                                            <c:when test="${asset.purchaseDate != null}">
                                                                <fmt:formatDate value="${asset.purchaseDateAsDate}" pattern="dd/MM/yyyy"/>
                                                            </c:when>
                                                    ...
                                                    <div class="col-md-8 detail-value">
                                                        <c:choose>
                                                            <c:when test="${asset.receivedDate != null}">
                                                                <fmt:formatDate value="${asset.receivedDateAsDate}" pattern="dd/MM/yyyy"/>
                                                            </c:when>
                                                            <c:otherwise>N/A</c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 detail-value">
                                                        <c:choose>
                                                            <c:when test="${asset.createdAt != null}">
                                                                <fmt:formatDate value="${asset.createdAtAsDate}" pattern="dd/MM/yyyy HH:mm"/>
                                                            </c:when>
                                                            <c:otherwise>N/A</c:otherwise>
                                                        </c:choose>
                                                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="changeStatusForm" method="post" action="${pageContext.request.contextPath}/assets">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="changeStatusForm" class="btn btn-warning">
